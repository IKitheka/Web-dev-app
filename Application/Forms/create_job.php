  ...
  <div class="content">
    ...
    <form class="form-section">
      <div class="form-group">
        ...
        <input type="text" class="form-input" placeholder="e.g. Data Science Intern">
      </div>
      <div class="form-group">
        <label class="form-label">Duration</label>
        <input type="text" class="form-input" placeholder="e.g. 3 months">
      </div>
      <div class="form-group">
        <label class="form-label">Location</label>
        <input type="text" class="form-input" placeholder="e.g. Remote / Nairobi">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <textarea class="form-textarea" placeholder="Required skills, education level..."></textarea>
      </div>
      <div class="form-group">
        <label class="form-label">Description</label>
        <textarea class="form-textarea" placeholder="Job roles, company mission..."></textarea>
      </div>
      <button type="submit" class="btn">Publish Internship</button>
    </form>
  </div>
